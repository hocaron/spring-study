package com.springstudy.httplogging.common.wrapper;
...
public class CachingResponseWrapper extends HttpServletResponseWrapper {
    ...
    public PrintWriter getWriter() throws IOException {
        if (writer == null) {
            writer = new PrintWriter(new OutputStreamWriter(content, this.getCharacterEncoding()),
                true);
        }
        return writer;
    }
    ...
    private class CachedServletOutputStream extends ServletOutputStream {
        ...
        public CachedServletOutputStream(ServletOutputStream one, FastByteArrayOutputStream two) {
